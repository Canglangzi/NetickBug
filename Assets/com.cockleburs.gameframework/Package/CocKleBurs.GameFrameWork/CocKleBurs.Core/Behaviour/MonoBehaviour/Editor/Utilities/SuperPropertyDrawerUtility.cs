...
{
    public class SuperPropertyDrawerUtility
    {
        // Singleton
        private static SuperPropertyDrawerUtility s_instance;
		public  static SuperPropertyDrawerUtility Instance => s_instance ?? (s_instance = new SuperPropertyDrawerUtility());
        ...
        // Initialization
		public  void InitializePropertyDrawerList()
        {
		...
		public  SuperPropertyDrawer GetPropertyDrawer(Type type, SuperSerializedProperty property)
        {
        ...
        // [] Operator
		public  SuperPropertyDrawer this[SuperSerializedProperty property] => GetPropertyDrawer(property.Type, property);
