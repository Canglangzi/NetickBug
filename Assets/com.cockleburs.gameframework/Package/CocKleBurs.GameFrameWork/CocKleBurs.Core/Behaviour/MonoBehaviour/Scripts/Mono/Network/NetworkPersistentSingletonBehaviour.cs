...
/// <summary>
/// A singleton NetworkBehaviour that persists across scenes and is created immediately on Awake.
/// </summary>
/// <typeparam name="T"></typeparam>
public class NetworkPersistentSingletonBehaviour<T> : NetworkBehaviour where T : Component
{
