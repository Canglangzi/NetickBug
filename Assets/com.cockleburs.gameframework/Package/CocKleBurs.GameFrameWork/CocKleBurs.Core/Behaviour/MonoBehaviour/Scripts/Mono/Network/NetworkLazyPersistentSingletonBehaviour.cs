...
/// <summary>
/// A lazy singleton NetworkBehaviour that persists across scenes and is created only when first accessed.
/// </summary>
/// <typeparam name="T"></typeparam>
public class NetworkLazyPersistentSingletonBehaviour<T> : NetworkBehaviour where T : Component
{
